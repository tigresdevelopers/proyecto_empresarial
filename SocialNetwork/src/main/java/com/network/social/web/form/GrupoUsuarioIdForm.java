...
public class GrupoUsuarioIdForm extends BaseForm {
	...
	public GrupoUsuarioIdForm() {
	}

	public GrupoUsuarioIdForm(Integer idgrupo, Integer idusuario) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GrupoUsuarioIdForm))
			return false;
		GrupoUsuarioIdForm castOther = (GrupoUsuarioIdForm) other;
